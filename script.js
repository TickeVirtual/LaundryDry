 // Obtener los parámetros de la URL
   ...
   const mensajes = [
    ...
    document.getElementById('sendMessageButton').addEventListener('click', async function () {
        ...
        const url = "https://mensajero-evolution-api.ykf6ye.easypanel.host/message/sendMedia/laundrydryinstancia"; // Cambia NOMBRE_INSTANCIA
        const apikey = "108EFEC34CD4-4789-888E-AF00903BAFA4"; // Coloca aquí tu API key
